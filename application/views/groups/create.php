                ...
                <div class="form-group">
                  ...
                  <table class="table table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>article_stock</td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="createArt" class="minimal"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="updateArt" class="minimal"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewArt" class="minimal"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="deleteArt" class="minimal"></td>
                      </tr>
                      <tr>
                        <td>article</td>
